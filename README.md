# Pico_Template Lite (v1.6.1)
- What's removed: 
- no need package perf_counter
- no need package retarget
- no support retarget printf,please use uart
- no LCD 1.3inc Module
- Note: 
- remember to choose SPI flash in .\pico-sdk\src\rp2_common\boot_stage2\include\boot_stage2\config.h
- bad SPI config cause boot hang 
