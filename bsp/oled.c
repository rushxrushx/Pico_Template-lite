...
void OLED_Init(void)
{
    gpio_init(OLEDPIN_CL);
    gpio_set_dir(OLEDPIN_CL, GPIO_OUT);
	
    gpio_init(OLEDPIN_DA);
    gpio_set_dir(OLEDPIN_DA, GPIO_OUT);
	
    gpio_init(OLEDPIN_RST);
    gpio_set_dir(OLEDPIN_RST, GPIO_OUT);
	
    gpio_init(OLEDPIN_DC);
    gpio_set_dir(OLEDPIN_DC, GPIO_OUT);
	
    gpio_init(OLEDPIN_CS);
    gpio_set_dir(OLEDPIN_CS, GPIO_OUT);
	...
	OLED_WR_Byte(0x60,OLED_CMD); /*128*/ 
